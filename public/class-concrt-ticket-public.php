 ...
 * @subpackage Concrt_Ticket/public
 */
...
class Concrt_Ticket_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Concrt_Ticket_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Concrt_Ticket_Loader will then create the relationship
