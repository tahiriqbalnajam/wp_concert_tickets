...
class Concrt_Ticket {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Concrt_Ticket_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Concrt_Ticket_Loader. Orchestrates the hooks of the plugin.
	 * - Concrt_Ticket_i18n. Defines internationalization functionality.
	 * - Concrt_Ticket_Admin. Defines all hooks for the admin area.
	 * - Concrt_Ticket_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Concrt_Ticket_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
